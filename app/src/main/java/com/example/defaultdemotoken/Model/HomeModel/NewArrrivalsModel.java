...
public class NewArrrivalsModel {
    ...
    public NewArrrivalsModel(String name, String image, String sku, String id, String rating, String price,String isWishlisted, String wishlist_item_id) {
        this.name = name;
        this.image = image;
        this.sku = sku;
        this.id = id;
